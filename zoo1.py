...
if __name__ == "__main__":
    ...
    zookeeper = ZooKeeper("Иван Сидоров")
    veterinarian = Veterinarian("Петр Иванов")
    ...
    print(zoo)
    print(zookeeper.feed_animal(mammal))
    print(veterinarian.heal_animal(reptile))
